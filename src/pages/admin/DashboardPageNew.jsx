...
export const AdminDashboardPage = ({ adminId, adminInfo }) => {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      // Fetch all data in parallel - Admin sees only their data
      const [
        orderStatsRes, 
        productStatsRes, 
        ordersRes, 
        ...
        orderService.getOrders({ limit: 10, sort: '-createdAt' }), // Get all recent orders (will filter in UI)
      ...
      const totalOrders = orderStats.totalOrders || orderStats.count || 0;
      ...
      // Set recent orders (exclude cancelled orders from display)
      ...
      for (let i = 6; i >= 0; i--) {
        ...
        weekData.push({
          ...
          stock: totalProducts - lowStock,
          outOfStock: lowStock,
          revenue: totalRevenue / 7
        });
      }
      ...
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={4}>
        <Box>
          <Typography variant="h4" fontWeight={700} sx={{ color: '#111827', mb: 0.5 }}>
            {adminInfo ? `${adminInfo.name}'s Dashboard` : 'My Dashboard'}
          </Typography>
              ...
              <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
                ...
                <Box display="flex" gap={1}>
                  <Chip
                    ...
                    size="small"
                    sx={{
                      backgroundColor: selectedWeek === 'this' ? '#D1FAE5' : 'transparent',
                      color: selectedWeek === 'this' ? '#065F46' : 'text.secondary',
                      cursor: 'pointer'
                    }}
                  ...
                  <Chip
                    ...
                    size="small"
                    sx={{
                      backgroundColor: selectedWeek === 'last' ? '#D1FAE5' : 'transparent',
                      color: selectedWeek === 'last' ? '#065F46' : 'text.secondary',
                      cursor: 'pointer'
                    }}
