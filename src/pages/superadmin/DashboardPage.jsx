...
import { Grid, Card, CardContent, Typography, Box, CircularProgress, IconButton, Tooltip } from '@mui/material';
import { 
  ShoppingCart, 
  Inventory, 
  People, 
...
export const SuperAdminDashboardPage = () => {
  ...
  }, [dispatch, products, refreshKey]); // Re-fetch when products change or manual refresh
      ...
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={2}>
        <Box>
          ...
          <Typography color="text.secondary">
            Overall view of all admins. Go to Admin Management to view individual admin dashboards.
          </Typography>
        </Box>
